...
export default async (
  ...
  if (opts.cliArgs['save-peer'] || opts.cliArgs['save-optional-peer']) {
    ...
    if (opts.cliArgs['save-optional-peer']) {
      pnpmConfig.lockfileOnly = !pnpmConfig.saveDev
    } else {
